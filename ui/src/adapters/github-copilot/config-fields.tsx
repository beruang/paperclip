...
export function GitHubCopilotConfigFields({
  ...
  return (
    <>
      <SecretField
        label="GitHub Token"
        hint="GitHub personal access token with Copilot scope. Can also be set via GITHUB_TOKEN environment variable."
        value={
          isCreate
        ...
        placeholder="ghp_..."
      />
      <Field label="Model" hint="Select the model to use via GitHub Copilot.">
        <select
          value={currentModel}
          onChange={(e) =>
            isCreate
