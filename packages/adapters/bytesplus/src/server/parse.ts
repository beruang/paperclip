...
interface ParsedBytesPlusResponse {
...
export function parseBytesPlusResponse(responseText: string): ParsedBytesPlusResponse {
  const result: ParsedBytesPlusResponse = {
...
export function isBytesPlusUnknownSessionError(stdout: string, stderr: string): boolean {
